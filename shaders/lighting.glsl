...
void main() {
    ...
    vec3 diffuse = u_light.diffuse * vec3(max(dot(norm, lightDir), 0.0)) * u_material.diffuse;
    vec3 specular = u_light.specular * specularComponent * u_material.specular * vec3(texture(texture_specular0, v_texCoord));
