...
void imguistuff(double deltatime, double renderdeltatime, glm::vec3 &translation1, glm::vec3 &rotation1, glm::vec3 &scale1, ControllableCamera &cam, glm::vec3 &cuberotation, glm::vec3 &ClearColor, float &frequencyHZ)
{
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        Vertex cubeVertices[] = {
            //  x      y      z         xtex   ytex   tex id
            {   -magicValue, -0.5f, -0.5f,    0.0f,  0.0f,  1,   },
            {    magicValue, -0.5f, -0.5f,    1.0f,  0.0f,  1,   },
            {    magicValue,  0.5f, -0.5f,    0.0f,  1.0f,  1,   },
            {   -magicValue,  0.5f, -0.5f,    0.0f,  1.0f,  1,   },
            {   -0.5f, -0.5f,  0.5f,    0.0f,  0.0f,  0,   },
            {    0.5f, -0.5f,  0.5f,    1.0f,  0.0f,  0,   },
            {    0.5f,  0.5f,  0.5f,    1.0f,  1.0f,  0,   },
        ...
        imguistuff(deltatime, renderdeltatime, translation1, rotation1, scale1, camera, cuberotation, ClearColor, frequencyHZ);
